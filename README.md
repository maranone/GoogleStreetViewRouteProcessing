```sh
Street_View.py for generating images
Upscale.vbs for upscaling (optional)

ffmpeg -framerate 30 -i .\output\image_%%06d.png -vf "fps=60,tblend=all_mode=average" -an -c:v libx264 -crf 18 -preset veryslow -y raw.mp4
# generate raw with street view, raw2 and raw3 for map view
